...
class ForgotPasswordUseCase @Inject constructor(private val apiService: ApiService) {

    operator fun invoke(data: ForgotPasswordRequest) = flow<State<CommonResponse>> {
        apiService.forgotPassword(data).run {
