...
class GetUserUseCase @Inject constructor(private val apiService: ApiService) {

    operator fun invoke(token:String,data: String) = flow<State<UserResponse>> {

        apiService.getUser(token,data).run {
