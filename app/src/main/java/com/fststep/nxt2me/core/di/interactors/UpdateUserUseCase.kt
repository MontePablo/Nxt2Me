...
class UpdateUserUseCase @Inject constructor(private val apiService: ApiService) {

    operator fun invoke(token:String,data: User,id:String) = flow<State<CommonResponse>> {

        apiService.updateUser(token,data,id).run {
