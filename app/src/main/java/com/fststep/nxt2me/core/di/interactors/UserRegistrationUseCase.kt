...
class UserRegistrationUseCase @Inject constructor(private val apiService: ApiService) {

    operator fun invoke(regData: UserRegistrationRequest) = flow<State<UserResponse>> {
        apiService.registerUser(regData).run {
