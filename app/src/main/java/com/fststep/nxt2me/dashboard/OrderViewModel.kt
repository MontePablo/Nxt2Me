...
import com.fststep.nxt2me.core.di.interactors.CreateOrderUseCase
...
class OrderViewModel @Inject constructor(
    ...
    var createOrderResponse: MutableLiveData<State<CommonResponse>> = MutableLiveData()
    ...
    fun createOrder(data:CreateOrderRequest) {
        val token="Bearer "+Preferences.fetchToken()
        viewModelScope.launch {
            createOrderUseCase(token,data).collect {
