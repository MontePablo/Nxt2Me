...
import com.fststep.nxt2me.databinding.ActivityCreateEventBinding
import java.io.File
...
class CreateEventActivity: AppCompatActivity() {
    ...
    private lateinit var mBinding:ActivityCreateEventBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding.tvPreview.setOnClickListener {
            ...
            mBinding.tvName.text = mBinding.etEventName.text.toString()
