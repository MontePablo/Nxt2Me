...
class PeopleInterestListAdapter(var context: Context, private val dataSet: ArrayList<MeetPeopleItemInfo>) :
    RecyclerView.Adapter<PeopleInterestListAdapter.ViewHolder>() {
